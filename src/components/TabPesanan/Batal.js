...
export default function Batal() {
    ...
    const fetchData = () => {
        ...
        return fetch(API_URL + '/api/getPesanan?id_kustomer=' + user.ID + '&status=batal&token=' + user.TOKEN + '&page=' + pageNumber + '&limit=10')
    ...
    const _loadMoreData = (page) => {
        ...
        fetch(API_URL + '/api/getPesanan?id_kustomer=' + user.ID + '&status=batal&token=' + user.TOKEN + '&page=' + page + '&limit=10')
            .then((response) => response.json())
            .then((res) => {
        ...
        <>
            <View style={{ backgroundColor: 'white' }}>
                <View style={{ paddingVertical: 10, backgroundColor: 'red' }}>
                    <Text style={{ textAlign: 'center', fontSize: 18, color: 'white' }}>Pesanan Batal</Text>
                </View>
            </View>
            {
