        ...
        <View>
            <View style={{backgroundColor: '#F48734', position: 'relative'}}>
                ...
                <View style={{position: 'relative', flexDirection: 'column', alignItems: 'center', zIndex: 9999}}>
                    <View style={{width: '80%', zIndex: 9999, paddingHorizontal: 20, backgroundColor: 'white', position: 'absolute', top: -15, paddingVertical: 20}}>
            ...
            <View style={{backgroundColor: 'white', zIndex: -1, marginTop: 100, marginHorizontal: 35}}>
                <TouchableOpacity
                    onPress={() => navigation.navigate('CGantiPassword')} 
                    style={{paddingVertical: 10, borderTopColor: '#000', borderTopWidth: 0.3}}>
