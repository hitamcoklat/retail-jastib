...
export default function CDetailPesanan({ route }) {
    ...
    const [imgPembayaran, setImgPembayaran] = useState(item.UPDATE_PEMBAYARAN.url)
    ...
    return (
        <>
            <ScrollView>
                ...
                <View style={{ backgroundColor: 'white', marginTop: 10, flexDirection: 'column', justifyContent: 'space-between', paddingHorizontal: 20, paddingVertical: 20 }}>
                    <View>
                        <Text style={{ fontSize: 16, marginBottom: 10 }}>Foto Bukti Pembayaran :</Text>
                        <Lightbox underlayColor="white">
                            <Image
                                style={{ flex: 1, height: 150 }}
                                resizeMode="contain"
                                source={{ uri: imgPembayaran }}
                            />
                        </Lightbox>
                    </View>
                    <TouchableOpacity
                        onPress={() => {
                            navigation.navigate('UploadPembayaran', { item: item })
                        }}
                        style={{ backgroundColor: 'green', paddingVertical: 10, borderRadius: 5, marginHorizontal: 5, marginTop: 10 }}>
                        <Text style={{ textAlign: 'center', fontWeight: 'bold', color: 'white', fontSize: 14 }}>Upload Bukti Pembayaran</Text>
                    </TouchableOpacity>                    
                </View>
                ...
                <View style={{ backgroundColor: 'white', paddingVertical: 20, paddingHorizontal: 10, flexDirection: 'column', justifyContent: 'space-between' }}>
                    <TouchableOpacity
                        onPress={() => {
                            navigation.goBack()
                        }}
                        style={{ backgroundColor: 'orange', paddingVertical: 10, borderRadius: 5,  marginHorizontal: 5 }}>
